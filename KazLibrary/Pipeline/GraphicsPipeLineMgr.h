...
enum PipeLineDataNames
{
	...
	PIPELINE_DATA_BACKCARING_ALPHABLEND_RNEDERTARGET_SECOND_RAYTRACING,	// レイトレ用で実装しました。レンダーターゲットがR16G16B16A16
...
enum PixelShaderNames
{
	...
	SHADER_PIXEL_FBX_RENDER_TWO_RAYTRACING,	// レイトレ用で新しく用意。
...
enum PipeLineNames
{
	...
	PIPELINE_NAME_FBX_RENDERTARGET_TWO_RENDERUAV,	// レイトレ用で作ったパイプライン
